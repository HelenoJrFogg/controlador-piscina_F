...
#define ONE_WIRE_BUS_PISC                    2// //12 // Pino do sensor da temperatura da piscina
#define ONE_WIRE_BUS_PAINEL                  3// 13 // Pino do sensor do painel de aquecimento
#define ONE_WIRE_BUS_RETORNO                 4// 14 // Pino sensor de retorno de agua
...
//int analogreading;
int buttonPinSet = 11; //= 15;    // the number of the pushbutton pin
...
int debounceDelay = 50;    // the debounce time; increase if the output flickers
 ...
 int buttonPinUp = 12; // = 0;    // the number of the pushbutton pin
...
//unsigned long lastDebounceTimeUp = 0;  // the last time the output pin was toggled
 ...
 int buttonPinDw = 10; // = 2;    // the number of the pushbutton pin
...
// include the library code://https://github.com/adafruit/Adafruit_LiquidCrystal
